...
(function($) {
    ...
    function FormGenerator() {
         ...
         * @param {function} condition Функция проверяющая условие добавления елемента в форму, принимает объект содержащий данные о структуре поля, должна возвращать
